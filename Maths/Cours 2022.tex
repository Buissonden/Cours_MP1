...
\section{Continuité de la somme d'une série entière sur $\C$}
...
\item La série $\sum\int_I\vert u_n\vert$
\end{itemize}
...
\item il existe une focntion $\varphi$ continue par morceaux, positive et intégrable sur $I$ telle que \par \begin{center}$\forall (\lambda, t)\in J\times I, \vert f_\lambdat(t)\vert\leq \varphi(t)$ (hypothèse de domination)\end{center}
\end{itemize}
