...
\par Ses solutions sont les fonctions $y\in\mathcal{D}_p(I, \K)$ vérifiant $\forall t\in I, y^{(p)}(t) + a_{p-1}(t)y^{(p-1)}(t)+...+a_0(t)y(t) =b(t)$}
...
\subsection{Généralités sur l'équation du premier ordre}
